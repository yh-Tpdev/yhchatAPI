---
url: /api/wss/chat-ws-go.jwzhd.com.md
---
...
!!其实可以和接收消息推送的 proto 基本共用,只是编辑消息额外多了个14 edit\_time.!!
...
::: tip
流式消息第一个推送是 push\_message,后续才是 stream\_message,需要将 content 里面的内容追加到消息内容后面.
:::
